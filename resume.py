...
if pdf is not None:
      ...
      query = "Please provide the following candidate details: Name, Email, Phone Number, Education, Experience, skills, DOB. Please provide each data in new line so that easy to understand and also add heading infront of that record."
